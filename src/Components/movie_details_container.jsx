    ...
    return (
        <>
            <div className="mb-6 flex items-center justify-between">
                <Link to="home" className="inline-flex items-center gap-2 px-4 py-2 bg-slate-900 border border-slate-800 text-slate-300 hover:text-white hover:bg-slate-800 rounded-xl text-sm font-semibold transition-all">
                    <span>←</span>
...
export default movie_details_container