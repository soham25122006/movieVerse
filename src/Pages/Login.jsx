...
function Login() {
  ...
  const { showToast, updateProfile } = useMovieContext();
  ...
  const handleDemoLogin = () => {
    ...
    updateProfile({ name: 'Alex Rivera' });
  ...
  return (
    <div className="bg-slate-950 text-slate-100 font-sans antialiased min-h-screen flex flex-col selection:bg-red-600 selection:text-white">
      <main className="flex-1 max-w-md w-full mx-auto px-4 py-12 flex flex-col justify-center animate-fade-in">
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSignIn} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-red-600 hover:bg-red-700 text-white rounded-xl font-bold text-sm shadow-xl transition-all hover:scale-[1.02] cursor-pointer"
            >
              Sign In
            </button>
          </form>
          ...
          <div className="relative my-6 text-center">
            ...
            <span className="relative bg-slate-900 px-3 text-slate-500 text-xs font-semibold uppercase">
              Or Quick Test
            </span>
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white rounded-xl text-xs font-bold border border-slate-700 transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
